...
SCHEMA = {
    ...
    'definitions': {
        ...
        'internetSign': {
            'tag': 1108,
            'type': 'number',
            'description': 'признак расчетов в Интернете',
        },
        'serviceSign': {
            'tag': 1109,
            'type': 'number',
    ...
    'properties': {
        'fiscalReport': {
            ...
            'properties': {
                ...
                'bsoSign': {'$ref': '#/definitions/bsoSign'},
                'serviceSign': {'$ref': '#/definitions/serviceSign'},
                'encryptionSign': {'$ref': '#/definitions/encryptionSign'},
                'autoMode': {'$ref': '#/definitions/autoMode'},
                'machineNumber': {'$ref': '#/definitions/machineNumber'},
                'internetSign': {'$ref': '#/definitions/internetSign'},
                'fiscalDocumentNumber': {'$ref': '#/definitions/fiscalDocumentNumber'},
                'fiscalDriveNumber': {'$ref': '#/definitions/fiscalDriveNumber'},
                'operator': {'$ref': '#/definitions/operator'},
                'retailPlaceAddress': {'$ref': '#/definitions/retailPlaceAddress'},
                'ofdInn': {'$ref': '#/definitions/ofdInn'},
                'kktNumber': {'$ref': '#/definitions/kktNumber'},
                'fiscalSign': {'$ref': '#/definitions/fiscalSign'},
                'properties': {'$ref': '#/definitions/properties'},
            },
            'additionalProperties': False,
        ...
        'fiscalReportCorrection': {
            ...
            'properties': {
                ...
                'correctionReasonCode': {
                    'type': 'array',
                    'items': {
                        '$ref': '#/definitions/correctionReasonCode'
                    },
                },
                'fiscalSign': {'$ref': '#/definitions/fiscalSign'},
                'properties': {'$ref': '#/definitions/properties'},
    ...
    'oneOf': [
        ...
        {'required': ['fiscalReportCorrection']},
        {'required': ['openShift']},
        {'required': ['receipt']},
        # {'required': ['bso']},
        {'required': ['closeShift']},
